...
class RansacAffineModel(object):
	...
	def A_from_ransac(fp,tp,model,maxiter=5000,match_threshold=10):
		data = vstack((fp,tp))
		A,ransac_data = ransac.ransac(data.T,model,4,maxiter,match_threshold,0,debug=False,return_all=True)
